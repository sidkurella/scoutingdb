<?php
session_start();
if(!isset($_SESSION['id']) || $_SESSION['loggedin']){} else {
                                ...
                                <form method="post" action="robot_submit.php">
                                    <div class="row uniform 50%">
                                        ...
                                        <div class="2u 12u$(xsmall)">
                                            <input type="text" name="teamnum" id="teamnumber" value="" placeholder="Team Number" required/>
                                        </div>
                                        ...
                                        <div class="4u 12u$(medium)">
                                            <input type="number" min="0" max="15" id="shooterdist" name="shooterdist" placeholder="Shot Distance (in ft)"/>
                                        </div>
                                        <div class="4u 12u$(medium)">
                                            <input type="number" min="0" step="0.1" id="shooterspeed" name="shooterspeed" placeholder="Shot Speed (in balls/s)"/>
                                        </div>
                                        <div class="4u$ 12u$(medium)">
                                        ...
                                        <div class="4u 12u$(medium)">
                                            <input type="number" min="0" step="0.5" id="drivespeed" name="drivespeed" placeholder="Drive Speed (in ft/s)"/>
                                        </div>
                                        <div class="4u 12u$(medium)">
                                        ...
                                        <div class="4u 12u$(medium)">
                                            <input type="number" min="0" step="0.5" id="intakespeed" name="intakespeed" placeholder="Intake Speed (in balls/s)"/>
                                        </div>
                                        <div class="4u 12u$(medium)">
                                        ...
                                        <div class="4u 12u$(medium)">
                                            <input type="number" min="0" step="5" id="liftmaxweight" name="liftmaxweight" placeholder="Maximum Lift Weight (in lb)"/>
                                        </div>
                                        <div class="4u 12u$(medium)">
                                        ...
                                        <div class="6u 12u$(medium)">
                                            <input type="number" min="0" max="18" step="1" id="robotheight" name="robotheight" placeholder="Height of Robot (in in)"/>
                                        </div>
                                        <div class="6u$ 12u$(medium)">
                                            <input type="number" min="0" max="18" step="1" id="robotshooterheight" name="robotshooterheight" placeholder="Height of Shooter (in in)"/>
                                        </div>
                                        <div class="6u 12u$(medium)">
                                            <input type="number" min="0" step="5" id="robotweight" name="robotweight" placeholder="Robot Weight (in lb)"/>
                                        </div>
                                        <div class="6u$ 12u$(medium)">
                                        ...
                                        <div class="4u 12u$(medium)">
                                            <input type="number" min="0" step="5" id="autonpointsscored" name="autonpointsscored" placeholder="Points Scored"/>
                                        </div>
                                        <div class="4u 12u$(medium)">
                                            <input type="number" min="0" step="5" id="autonpointsattempted" name="autonpointsattempted" placeholder="Points Attempted"/>
                                        </div>
                                        <div class="4u$ 12u$(medium)">
                                            <input type="number" min="0" max="10" step="1" id="autonreliability" name="reliability" placeholder="Reliability (from 1-10)"/>
                                        </div>
                                        ...
                                        <div class="6u 12u$(medium)">
                                            <input type="number" min="0" step="5" id="skillsdriver" name="skillsdriver" placeholder="Robot Skills Score"/>
                                        </div>
                                        <div class="6u$ 12u$(medium)">
                                            <input type="number" min="0" step="5" id="skillsprog" name="skillsprog" placeholder="Programming Skills Score"/>
                                        </div>
