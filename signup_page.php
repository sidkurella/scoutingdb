			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
						<header class="major">
							<h2>Sign up</h2>
							<p>Sign up to access internal use scouting forms.</p>
						</header>
                                ...
                                <form method="post" action="register.php">
                                    <div class="row uniform 50%">
                                        ...
                                        <div class="12u$ 12u$(xsmall)">
                                            <input type="text" name="name" id="namelog" value="" placeholder="Full Name" required/>
                                        </div>
                                        <div class="6u 12u$(xsmall)">
                                            <input type="text" name="email" id="emaillog" value="" placeholder="Email Address" required/>
                                        </div>
                                        <div class="6u$ 12u$(xsmall)">
                                            <input type="text" name="phone" id="phonelog" value="" placeholder="Phone Number" required/>
                                        </div>
                                        <div class="12u$">
                                            <ul class="actions">
